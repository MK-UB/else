...
/*   Updated: 2023/02/19 20:56:04 by melayoub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_flood_fill(t_list *content, int xp, int yp)
{
    ...
    if (content->matrice[yp - 1][xp] == '1' && content->map[yp - 1][xp]  != '1' && content->map[yp - 1][xp]  != 'E')
         ft_flood_fill(content,xp, yp - 1);
	// while(content->matrice[yp][xp] == '0')
	// 	{
	// 		if(content->matrice[yp][xp + 1] == '0' || content->matrice[yp][xp - 1] == '0' || content->matrice[yp + 1][xp] == '0' || content->matrice[yp - 1][xp] == '0')
	// 	}
	// printf("mat:%s", content->matrice[3]);
}
